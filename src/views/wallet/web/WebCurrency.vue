  ...
  <div class="flex">
    <a-spin :spinning="props.loading">
      <div class="flex overflow-x-auto gap-x-4">
        <div
          class="py-2 rounded text-center min-w-[250px] shadow my-2"
          v-for="asset in props.walletAccounts"
          :key="asset.currency"
        >
          ...
          <div class="flex justify-center gap-x-2">
            <a-button
              @click="
                (e) => {
                  onClick(e, asset.currency, 'topup');
                }
              "
              type="link"
            >
            ...
            <a-button
              ...
              @click="
                (e) => {
                  onClick(e, asset.currency, 'withdraw');
                }
              "
            >
            ...
            <a-button
              ...
              @click="
                (e) => {
                  onClick(e, asset.currency, 'transfer');
                }
              "
            >
