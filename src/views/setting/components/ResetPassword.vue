...
<template>
  <a-form :rules="rules" :ref="formRef" class="px-4 py-2" layout="vertical">
    <a-form-item v-bind="validateInfos.oldPassword" label="舊密碼">
      <a-input-password
    ...
    <a-form-item v-bind="validateInfos.password" label="新密碼">
      <a-input-password
    ...
    <a-form-item v-bind="validateInfos.confirm" label="確認密碼">
      <a-input-password
