...
<template>
  <a-drawer :title="$t('-U3HyWKyrOuRzqUpJAU-u')" placement="right" :visible="props.visible" :closable="false"
    width="480px" @close="closeDrawer" @afterVisibleChange="onDrawerVisible">
    <template #extra>
    ...
    <div class="mb-4">
      ...
      <div class="flex items-center justify-center flex-col my-4">
        <div v-show="mode === 'scan'" class="text-center">
          <img :src="props.codeImgUrl" alt="code" class="w-[200px] min-h-[200px]" />
    ...
    <div>
      ...
      <div class="flex items-center justify-center">
        <div class="space-x-2">
          <a-input v-for="(value, index) in code" :key="index" ref="inputRefs" v-model:value="code[index]"
            @change="handleChange(index)" class="p-2 text-center w-10 rounded-md" maxlength="1" />
        </div>
      </div>
    </div>
  </a-drawer>
