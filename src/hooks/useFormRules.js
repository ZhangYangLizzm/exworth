...
const useFormRules = () => {
    ...
    const EmailRule = [{ required: true, message: t("8dRn48_9RTO6Q2804fgFp") }, { pattern: emailPattern, message: 'Invalid email format' }]
    ...
    return { NetworkRule, AddressRule, UUIDRule, CurrencyRule, getAmountRule, SecurityPasswordRule, GoogleAuthCodeRule, EmailRule, CardNoRule }
}
